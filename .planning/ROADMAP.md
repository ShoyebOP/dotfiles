...
- [ ] **Phase 1: Universal Installer + Platform Foundations** - Bash entry + Termux-aware deps + correct stow; dry-run and checklist before any write
...
|-------|----------------|--------|-----------|
| 1. Universal Installer + Platform Foundations | 2/2 | In Progress|  |
